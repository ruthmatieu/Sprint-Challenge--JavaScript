...
const lowCaseAnimalNames = zooAnimals.map((value) => {
...
*/
const lowPopulationAnimals = zooAnimals.filter((total) => {
  return total.population < 5;
});
...
*/
const populationTotal = zooAnimals.reduce((arg1, arg2) => {
